                    ...
                    <div class="card-body">
                        <form action="{{ route('guru.update', $guru->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama"
                                            placeholder="Masukan nama guru" value="{{$guru->nama}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="password"
                                            placeholder="Masukan password" value="{{$guru->password}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="role" required>
                                            <option selected readonly value="{{$guru->role}}">{{$guru->role}}</option>
                                ...
                                <div class="col-md-6">
                                    <img src="{{ asset('public/guru/'.$guru->foto) }}" alt="Image" class="d-block"
