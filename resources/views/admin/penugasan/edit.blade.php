                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select w-100" name="id_guru" required>
                                            <option readonly selected value="{{$penugasan->id_guru}}">
                                                {{$penugasan->guru->nama}}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <select class="select w-100" name="id_mapel" required>
                                            <option readonly selected value="{{$penugasan->id_mapel}}">
                                                {{$penugasan->mapel->mapel}}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <select class="select w-100" name="id_ruangan" required>
                                            <option readonly selected value="{{$penugasan->id_ruangan}}">
                                                {{$penugasan->ruangan->ruangan}}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="porsi_jam"
                                            placeholder="Masukan porsi jam" value="{{$penugasan->porsi_jam}}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="text-end">
