    ...
    public function randIndividu(Request $request)
    {
        ...
        do {
            if ($loop == 1) {
                ...
                // $arrayList = [
                //     [3, 4, 5, 2, 1, 7, 6, 9, 8, 10, 12, 13, 15, 11, 14],
                //     [4, 5, 3, 2, 1, 7, 6, 9, 8, 10, 12, 13, 15, 11, 14],
                //     [5, 4, 3, 2, 1, 7, 6, 9, 8, 10, 12, 13, 15, 11, 14]
                // ];
                $arrayList = array();
                $penugasan = array();
                for ($i = 0; $i < $jum_idv; $i++) {
            ...
            if ($numParents == 0) {
                ...
                for ($i = 0; $i < $numParents; $i++) {
                    ...
                    $parentRight = array_slice($parent2, $titik_potong[$i]);
                    $child = array_merge($parentLeft, $parentRight);
